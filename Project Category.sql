...
INSERT INTO EMPLOYEE_S VALUES (2, 2, 'Fuller', 'Andrew', 'Vice President', 'Dr.', '02/9/1952', '08/4/1992', 10000.00, NULL); 
INSERT INTO EMPLOYEE_S VALUES (8, 2, 'Callahan', 'Laura', 'Sales Assistant', 'Miss', '01/09/58', '03/05/94', 2000.00, NULL);
INSERT INTO EMPLOYEE_S VALUES (4, 2, 'Peacock', 'Margaret', 'Sales Representative', 'Mrs.', '09/9/58', '05/03/93', 2856.00, 250.00);
INSERT INTO EMPLOYEE_S VALUES (3, 2, 'Leverling', 'Janet', 'Sales Representative', 'Miss', '08/10/63', '04/01/92', 3500.00, 1000.00);
INSERT INTO EMPLOYEE_S VALUES (1, 2, 'Davolio', 'Nancy', 'Sales Representative', 'Miss', '12/08/68', '05/01/92', 3135.00, 1500.00);
INSERT INTO EMPLOYEE_S VALUES (5, 2, 'Buchanan', 'Steven', 'Sales Manager', 'Mr.', '03/04/55', '10/7/93', 8000.00, NULL);
INSERT INTO EMPLOYEE_S VALUES (9, 5, 'Dodsworth', 'Anne', 'Sales Representative', 'Miss', '07/02/69', '11/5/94', 2180.00, 0.00);
INSERT INTO EMPLOYEE_S VALUES (6, 5, 'Suyama', 'Michael', 'Sales Representative', 'Mr.', '07/02/63', '10/7/93', 2534.00, 600.00);
INSERT INTO EMPLOYEE_S VALUES (7, NULL, 'King', 'Robert', 'Sales Representative', 'Mr.', '05/9/60', '01/02/94', 2356.00, 800.00);
...
ALTER TABLE EMPLOYEE_S  ADD CONSTRAINT FK_EMPLOYEES_EMPLOYES 
...
1. Senior Male Employees with Net Salary = 8000

SELECT EMPLOYEE_NUMBER, FIRST_NAME, LAST_NAME, 
       TIMESTAMPDIFF(YEAR, BIRTH_DATE, CURDATE()) AS AGE, 
       TIMESTAMPDIFF(YEAR, HIRE_DATE, CURDATE()) AS SENIORITY
FROM EMPLOYEES
WHERE (SALARY + COALESCE(COMMISSION, 0)) >= 8000
ORDER BY SENIORITY DESC;


2. Products Meeting Given Criteria
...
WHERE (COUNTRY, CITY, RIGHT(POSTAL_CODE, 3)) = 
      (SELECT COUNTRY, CITY, RIGHT(POSTAL_CODE, 3) 
       FROM SUPPLIERS WHERE SUPPLIER_NUMBER = 1);


4. Discount Rate for Orders Between 10998 and 11003
...
6. Customers from Berlin with At Most 1 Dessert Order
...
HAVING COUNT(OD.ORDER_NUMBER) <= 1;


7. Customers in France and Their Monday Orders in April 1998
SELECT C.CUSTOMER_CODE, C.COMPANY, C.PHONE, 
       COALESCE(SUM(OD.UNIT_PRICE * OD.QUANTITY), 0) AS TOTAL_AMOUNT, C.COUNTRY
FROM CUSTOMERS C
LEFT JOIN ORDERS O ON C.CUSTOMER_CODE = O.CUSTOMER_CODE
LEFT JOIN ORDER_DETAILS OD ON O.ORDER_NUMBER = OD.ORDER_NUMBER
...
8. Customers Who Have Ordered All Products
...
9. Number of Orders per Customer in France
...
10. Number of Orders in 1996 and 1997
SELECT 
